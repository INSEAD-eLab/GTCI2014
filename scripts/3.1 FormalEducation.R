...
science.engineering.ratios <- get.UNESCO.science.engineering.graduates(source.file="[R] [UNESCO] Graduates in science and engineering.xlsx",
...
science.engineering.ratios[,"science.and.engineering.ratio"] <- (science.engineering.ratios[,"graduates.science"] + science.engineering.ratios[,"graduates.engineering"]) / science.engineering.ratios[,"graduates.total"]
science.engineering.ratios[,"science.ratio"] <- science.engineering.ratios[,"graduates.science"] / science.engineering.ratios[,"graduates.total"]
science.engineering.ratios[,"engineering.ratio"] <- science.engineering.ratios[,"graduates.engineering"] / science.engineering.ratios[,"graduates.total"]
